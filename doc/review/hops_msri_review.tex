...
\centering
\tikzmarknode{n1}{} we are here \\ \vspace{0.5cm} 
\includegraphics[width=\textwidth]{snapshot-schedule.png}\tikzmarknode{snap}{}
\begin{tikzpicture}[remember picture,overlay]   %% use here too
\draw[-latex,visible on=<1>] (n1.west) to[out=200,in=135] ([xshift=-6.7cm,yshift=1cm] snap.north east);
\end{tikzpicture}
