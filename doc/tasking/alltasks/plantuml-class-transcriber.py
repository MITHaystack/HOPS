...
if __name__ == "__main__":
    # Files
    all_files = ['MHO_task_0100.txt', 'MHO_task_0200.txt', 'MHO_task_0300.txt', 'MHO_task_0305.txt', 
            'MHO_task_0307.txt', 'MHO_task_0310.txt', 'MHO_task_0350.txt', 'MHO_task_0370.txt', 
            'MHO_task_0380.txt', 'MHO_task_0390.txt', 'MHO_task_0400.txt', 'MHO_task_0500.txt']
    ...
    #--------------Test Cases-------------------#
    #assert some_function(some_value) == correct_value
    #assert some_function(some_other_value) == other_correct_value
