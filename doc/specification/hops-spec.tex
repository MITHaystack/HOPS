...
\lstinputlisting[language=C++,label={lst:metaobjects},caption=Meta-data object template classes for multi-type maps.]{./code/metadata_objects.hh}
...
Furthermore, a
mechanism for filtering operations (e.g. if station = Xx, apply this operator) needs to be

\lstinputlisting[language=C++,label={lst:operators},caption=Data operator template classes.]{./code/data_operators.hh}
