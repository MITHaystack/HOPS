...
memory management and array indexing/access from the user. They should not be overburdened with too much extraneous functionality that is specific to a particular operation the must be executed upon them (e.g. the N-dimensional array container should not implement a method to sum two arrays.), as this greatly
...
this would the case of GPU acceleration. Often to optimize GPU processing
