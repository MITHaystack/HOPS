...
Below is an incomplete table of the various data operations. A full description of each operation is specified in the subsequent pages.
\begin{center}
\resizebox{\textwidth}{!}{
\begin{tabular}{| c | c | 4cm | c |}
\hline
 Name & Type & Description & Input/Output \\  \hline
