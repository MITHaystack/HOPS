...
\title{User Manual for HOPS version 4}
...
\abstract{%
\large
This manual provides an overview of version 4 of \ac{HOPS} which
has been substantially rewritten since the version 3 series.
\FIXME[more to say]
}
