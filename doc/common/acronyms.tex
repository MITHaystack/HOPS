...
\begin{acronym}
% A---------------------------------------------------------------
\acro{A-list}{a one line description of baseline fringes used by HOPS}
...
\acro{DiFX}{the ``distributed'' FX correlator}
...
\acro{ngEHT}{next-generation Event Horizon Telescope}
...
\acro{Gbps}{refers to data recording rate, usually.  8 Gbps is 1 GB/s
    ...
    The HOPS era started with kbps worked through Mbps and ended
...
\acro{MSRI}{Mid-scale Research Infrastructure}
% N---------------------------------------------------------------
...
\acro{TBM}{Tasking Bubble Machine}
% U---------------------------------------------------------------
