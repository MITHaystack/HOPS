...
\newcommand{\EDIT}[1][edit]{{\color{blue}#1}}
...
% for itemizing and explaining requirements
\newcounter{req}
\newcommand{\reqid}[1]{\item[\refstepcounter{req}#1-\thereq]}
% the first argument should be one of rationale, explanation, comment
\newcommand{\reqex}[2][comment]{%
 \hfill\break\vspace{2pt}\hspace{-1em}{{\textsl{\textbf{#1}:}} \textit{{#2}}}}
