...
Record length is fixed at 128 bytes.  This record contains source-specific information.
...
Record length is fixed at 120 bytes.  This record contains the essentials of the fringe fit solution.
