...
observations. This correction is needed for maintaining proper polarization alignment
...
intended for use when a pseudo-Stokes-I summation of all four pol-products (XX, XY,
YY, YX) is requested.
...
:hops:`MHO_PolarizationRelabelerBuilder`
------------------------------------------

=============================================== ====================================================================
Class                                           :hops:`MHO_PolarizationRelabelerBuilder`
Primary Functionality                           Builds operators that relabel polarization products
Key Features                                    | Constructs multiple relabeling operators as needed
                                                | Relabels polarization products in visibility data
                                                | Relabels polarization products in weight data
                                                | Relabels polarization products in multitone pcal data
=============================================== ====================================================================

The :hops:`MHO_PolarizationRelabelerBuilder` class builds the operators needed to
relabel polarization products across visibility, weight, and multitone pcal
container data. It may construct multiple underlying operator classes to cover
each of these container types.
