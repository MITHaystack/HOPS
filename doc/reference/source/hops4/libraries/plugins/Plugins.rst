...
The python bindings plugin depends only on python (dev) and an integrated copy of the pybind11 header-only library 
and does not introduce any other external dependencies. 

The HDF5 export library requires the HDF5 development library (ibhdf5-dev) in order to be compiled, and provides
