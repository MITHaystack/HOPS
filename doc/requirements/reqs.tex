...
and implementation supports the needs of the ngEHT and so that by the conclusion of the project
a collection of test reports matching results to requirements may be presented.

Note that there is also an implicit desire to end up with a suite of software that
