...
version 6.
\reqex[Rationale]{\acs{A-list} files are the result of the Fourfit post
  processing that contain a fringe solution and summary plot for each scan/baseline.
  Compatibility with this dependency is necessary to be maintained when \acs{A-list}
  is updated in V.6.}
...
output \acs{A-list}.
\reqex[Rationale]{Compatibility with this dependency is necessary to be maintained
  when \acs{A-list} is updated in V.6.}
