...
\reqid{A} \ac{MHO} shall have the ability to automatically flag data based on
some specified criteria. For example it shall be possible to automatically discard correlator
