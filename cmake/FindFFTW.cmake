...
IF(FFTW_INCLUDE_DIRS)
  ...
  FIND_LIBRARY(FFTW_LIBRARIES fftw3 ${FFTW_LIBRARY_DIRS})
  FIND_LIBRARY(FFTW_SINGLE_LIBRARIES fftw3f ${FFTW_LIBRARY_DIRS})
  FIND_LIBRARY(FFTW_LONG_LIBRARIES fftw3l ${FFTW_LIBRARY_DIRS})
ELSE(FFTW_INCLUDE_DIRS)
  ...
  FIND_LIBRARY(FFTW_SINGLE_LIBRARIES fftw3f ${QMC_LIBRARY_PATHS})
  FIND_LIBRARY(FFTW_LONG_LIBRARIES fftw3l ${QMC_LIBRARY_PATHS})
...
IF(FFTW_INCLUDE_DIR AND FFTW_LIBRARIES)
  ...
  MESSAGE(STATUS "FFTW_SINGLE_LIBRARIES=${FFTW_SINGLE_LIBRARIES}")
  MESSAGE(STATUS "FFTW_LONG_LIBRARIES=${FFTW_SINGLE_LIBRARIES}")
  SET(FFTW_FOUND TRUE)
ENDIF()
