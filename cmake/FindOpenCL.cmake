...
ELSE (APPLE)
	...
	FIND_PATH( OPENCL_INCLUDE_DIRS CL/cl.h
        PATHS ${_OPENCL_INC_CAND} "/usr/include" "/usr/local/cuda/include" "/opt/AMDAPP/include"
	...
	FIND_PATH( OPENCL2_INCLUDE_DIRS CL/cl2.h
        PATHS ${_OPENCL_INC_CAND} "/usr/include" "/usr/local/cuda/include" "/opt/AMDAPP/include"
        ENV OpenCL_INCPATH ${OPENCL_INCLUDE_FLAG_DIR}
        )

	FIND_PATH( _OPENCL2_CPP_INCLUDE_DIRS CL/cl2.hpp
        PATHS ${_OPENCL_INC_CAND} "/usr/include" "/usr/local/cuda/include" "/opt/AMDAPP/include"
        ENV OpenCL_INCPATH ENV ${OPENCL_INCLUDE_FLAG_DIR}
        )
...
IF   ( OPENCL2_INCLUDE_DIRS)
	SET( OPENCL_IS_VERSION2 TRUE )
	LIST( APPEND OPENCL_INCLUDE_DIRS ${OPENCL2_INCLUDE_DIRS} )
	# This is often the same, so clean up
	LIST( REMOVE_DUPLICATES OPENCL_INCLUDE_DIRS )
ENDIF( OPENCL2_INCLUDE_DIRS)

IF( _OPENCL2_CPP_INCLUDE_DIRS )
	SET( OPENCL_HAS_CPP_BINDINGS TRUE )
	SET( OPENCL_IS_VERSION2 TRUE )
	LIST( APPEND OPENCL_INCLUDE_DIRS ${_OPENCL2_CPP_INCLUDE_DIRS} )
	# This is often the same, so clean up
	LIST( REMOVE_DUPLICATES OPENCL_INCLUDE_DIRS )
ENDIF( _OPENCL2_CPP_INCLUDE_DIRS )
