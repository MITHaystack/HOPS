...
rm -f ff-3571.ps
$verb && echo \
fourfit3 -pt -d diskfile:ff-3571.ps -b GE -c ./cf3571 -PI $DATADIR/3571/244-1717/0727-115.zbgwce
...
low=395.9
high=401
#high=396.3 (this value is from before the change to IXY fourfit3 amplitudes)
