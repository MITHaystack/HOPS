...
public class VEX2XML3 {
        ...
        formater.printHelp("VEX2XML3.sh -in inputfile.vex -out outputfile.xml",
            options);
    }
    ...
    private static void parseAndTranslate() throws Exception {
        ...
        vexGrammar3Lexer lexer = new vexGrammar3Lexer(input);
        CommonTokenStream tokens = new CommonTokenStream(lexer);
        vexGrammar3Parser parser = new vexGrammar3Parser(tokens, outputFile);
        parser.vex();
    ...
    public static void main(String[] args) throws Exception {   
        ...
        System.out.println("-------------------------------------" +
            "-------------------------------------");
        System.out.println("VEX2XML3.sh v. 1.3");
