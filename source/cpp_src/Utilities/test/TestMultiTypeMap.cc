...
class my_functor
{
    public:
        ...
        template< typename XValueType > void operator()(const XValueType& val) { std::cout << "value = " << val << std::endl; }
};
...
int main(int /*argc*/, char** /*argv*/)
{
    ...
    std::cout << "number of ints in par pack = " << count_instances_of_type< int, 3, int, int, char, double >::value
              << std::endl;
