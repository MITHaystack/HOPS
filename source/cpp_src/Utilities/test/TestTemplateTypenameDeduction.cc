...
int main(int /*argc*/, char** /*argv*/)
{
    ...
    std::cout<<" MHO_TupleElementNameWithoutSpaces< std::string >() = "<<MHO_TupleElementNameWithoutSpaces< std::string >()<<std::endl;
    std::cout<<" MHO_ClassName<std::string>()  = "<<MHO_ClassName<std::string>()<<std::endl;
    std::cout<<" MHO_ClassName< std::tuple< std::string > >()  = "<<MHO_ClassName< std::tuple< std::string > >()<<std::endl;
