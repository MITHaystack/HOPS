...
bool MHO_FringeControlInitialization::need_ion_search(mho_json* control)
{
                                                           ...
                                                           mho_json& control_statements)
{
    ...
    if(set_string != "")
    {
        cparser.PassSetString(set_string);
    }
...
void MHO_FringeControlInitialization::add_default_operator_format_def(mho_json& format)
{
...
void MHO_FringeControlInitialization::add_default_operators(mho_json& statements)
{
...
void MHO_FringeControlInitialization::add_polprod_sum_operator(mho_json& statements)
{
...
void MHO_FringeControlInitialization::add_dpar_sign_correction_operator(mho_json& statements)
{
...
bool MHO_FringeControlInitialization::is_circular_polprod(std::string pp)
{
    if(pp == "RR")
    {
        return true;
...
void MHO_FringeControlInitialization::add_circ_field_rotation_operator(mho_json& statements)
{
