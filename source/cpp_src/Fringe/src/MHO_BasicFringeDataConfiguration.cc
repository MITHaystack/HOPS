...
void MHO_BasicFringeDataConfiguration::parse_baseline_freqgrp(std::string baseline_freqgrp, std::string& baseline,
                                                              std::string& freqgrp)
{
...
std::string MHO_BasicFringeDataConfiguration::parse_set_string(const std::vector< std::string >& arglist, int& set_arg_index)
{
    set_arg_index = -1;
...
std::string MHO_BasicFringeDataConfiguration::sanitize_directory(std::string dir)
{
...
int MHO_BasicFringeDataConfiguration::sanity_check(MHO_ParameterStore* paramStore)
{
