#ifndef MHO_StationCoordinateModel_HH__
#define MHO_StationCoordinateModel_HH__
...
class MHO_StationCoordinateModel
{
    public:
        MHO_StationCoordinateModel();
        virtual ~MHO_StationCoordinateModel();
...
template< typename XCoeffVectorType >
void
MHO_StationCoordinateModel::EvaluateSpline(const XCoeffVectorType& coeff, double delta_t, double* results)
{
...
template< typename XTagType >
XTagType 
MHO_StationCoordinateModel::RetrieveTag(station_coord_type* data, std::string key)
{
...
#endif /* end of include guard: MHO_StationCoordinateModel_HH__ */
