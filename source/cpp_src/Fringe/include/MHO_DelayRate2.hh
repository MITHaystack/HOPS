#ifndef MHO_DelayRate2_HH__
#define MHO_DelayRate2_HH__

/*
*File: MHO_DelayRate2.hh
*Class: MHO_DelayRate2
*Author: J. Barrett
...
class MHO_DelayRate2: public MHO_BinaryOperator<
    visibility_type,
    weight_type,
    sbd_type >
{
...
#endif /* end of include guard: MHO_DelayRate2 */
