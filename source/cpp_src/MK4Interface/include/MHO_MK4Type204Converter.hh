#ifndef MHO_MKType204Converter_HH__
#define MHO_MKType204Converter_HH__
...
* A function that accepts the data from a type 204 file in the form of a struct and converts it to a JSON object.
**/
