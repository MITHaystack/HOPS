...
void
MHOMK4CorelInterface::ReadCorelFile(const std::string& filename)
{
...
void
MHOMK4CorelInterface::ExportCorelFile(Type100MetaData& meta, std::vector< Type101Map >& type101vector, std::vector< Type120Map >& type120vector)
{
    if(fHaveCorel)
    {
