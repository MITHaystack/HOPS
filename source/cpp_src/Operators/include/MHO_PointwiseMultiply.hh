#ifndef MHO_PointwiseMultiply_HH__
#define MHO_PointwiseMultiply_HH__
...
/*
*File: MHO_PointwiseMultiply.hh
*Class: MHO_PointwiseMultiply
*Author: J. Barrett
...
class MHO_PointwiseMultiply: public MHO_BinaryNDArrayOperator<XInputArrayType1, XInputArrayType2, XOutputArrayType >
{
    public:
...
#endif /* MHO_PointwiseMultiply_H__ */
