#ifndef MHO_MultidimensionalArbitraryPaddedFastFourierTransform_HH__
#define MHO_MultidimensionalArbitraryPaddedFastFourierTransform_HH__
...
class MHO_MultidimensionalArbitraryPaddedFastFourierTransform:
    public MHO_UnaryOperator< XArgType >
{
    public:
        ...
        MHO_MultidimensionalArbitraryPaddedFastFourierTransform()
        {
            fPaddedSize = 0;
        ...
        virtual ~MHO_MultidimensionalArbitraryPaddedFastFourierTransform()
        {
            DealocateWorkspace();
        };

        //factor M by which the new array will be extended (original array, length N, new array length NM)
        virtual void SetPaddedSize(std::size_t new_size){fPaddedSize = new_size;};
    ...
    protected:
        ...
        virtual bool InitializeOutOfPlace(const XArgType* in, XArgType* out)
        {
            ...
            {
                //output dimensions must of size fPaddedSize
...
#endif /* MHO_MultidimensionalArbitraryPaddedFastFourierTransform_H__ */
