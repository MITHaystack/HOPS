#ifndef MHO_MultidimensionalFastFourierTransformFFTW_Alt_HH__
#define MHO_MultidimensionalFastFourierTransformFFTW_Alt_HH__
...
class MHO_MultidimensionalFastFourierTransformFFTW_Alt:
    public MHO_UnaryOperator< XArgType >
{
    public:
        ...
        MHO_MultidimensionalFastFourierTransformFFTW_Alt()
        {
            fTotalArraySize = 0;
            fInPtr = NULL;
            fOutPtr = NULL;
        ...
        virtual ~MHO_MultidimensionalFastFourierTransformFFTW_Alt()
        {
            DealocateWorkspace();
            DestructPlan();
        };
...
#endif /* MHO_MultidimensionalFastFourierTransformFFTW_Alt_H__ */
