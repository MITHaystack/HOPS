#include "MHO_VexHighLevelBlockParser.hh"
...
MHO_VexHighLevelBlockParser::MHO_VexHighLevelBlockParser()
{
    fBlockLines = nullptr;
    fRefTag = "ref";
    fAssignmentDelim = "=;\n";
...
mho_json
MHO_VexHighLevelBlockParser::ParseBlockLines(std::string block_name, const std::vector< MHO_VexLine >* block_lines)
{
...
mho_json
MHO_VexHighLevelBlockParser::ParseBlock()
{
    mho_json block_root;
...
bool
MHO_VexHighLevelBlockParser::ContainsRefTag(const MHO_VexLine& line)
{
    bool ret_val = line.find(fRefFlag) != std::string::npos;
    return ret_val;
}

bool 
MHO_VexHighLevelBlockParser::ProcessStartTag(const MHO_VexLine& line, 
                     std::stack< std::string >& path,
                     std::stack< mho_json* >& file_node,
                     std::stack< mho_json >& format_node)
{
...
bool 
MHO_VexHighLevelBlockParser::ProcessStopTag(const MHO_VexLine& line, 
                      std::stack< std::string >& path,
                      std::stack< mho_json* >& file_node,
                      std::stack< mho_json >& format_node)
{
...
bool 
MHO_VexHighLevelBlockParser::ProcessLine(const MHO_VexLine& line, 
                 std::stack< std::string >& path,
                 mho_json* obj_node,
                 mho_json& format)
{
...
mho_json 
MHO_VexHighLevelBlockParser::ProcessTokens(const std::string& element_name, mho_json& format, std::vector< std::string >& tokens)
{
...
mho_json 
MHO_VexHighLevelBlockParser::ProcessInt(const std::string& element_name, mho_json&format, std::vector< std::string >& tokens)
{
...
mho_json 
MHO_VexHighLevelBlockParser::ProcessListInt(const std::string& element_name, mho_json&format, std::vector< std::string >& tokens)
{
    mho_json element_data;
...
mho_json 
MHO_VexHighLevelBlockParser::ProcessListString(const std::string& element_name, mho_json&format, std::vector< std::string >& tokens)
{
    mho_json element_data;
...
mho_json 
MHO_VexHighLevelBlockParser::ProcessReal(const std::string& element_name, mho_json&format, std::vector< std::string >& tokens)
{
    mho_json element_data;
...
mho_json 
MHO_VexHighLevelBlockParser::ProcessListReal(const std::string& element_name, mho_json&format, std::vector< std::string >& tokens)
{
    mho_json element_data;
...
mho_json 
MHO_VexHighLevelBlockParser::ProcessCompound(const std::string& element_name, mho_json&format, std::vector< std::string >& tokens)
{
    mho_json element_data;
...
MHO_VexHighLevelBlockParser::vex_element_type 
MHO_VexHighLevelBlockParser::DetermineType(std::string etype)
{
...
bool 
MHO_VexHighLevelBlockParser::MatchesType(const std::string& token, const std::string& type_name)
{
...
void 
MHO_VexHighLevelBlockParser::LoadBlockFormat(std::string block_name)
{
    fBlockFormatLoaded = false;
...
std::string 
MHO_VexHighLevelBlockParser::GetBlockFormatFileName(std::string block_name)
{
...
bool 
MHO_VexHighLevelBlockParser::ContainsWhitespace(std::string value)
{
