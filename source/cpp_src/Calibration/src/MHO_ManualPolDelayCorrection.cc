...
bool MHO_ManualPolDelayCorrection::ExecuteInPlace(visibility_type* in)
{
...
bool MHO_ManualPolDelayCorrection::PolMatch(std::size_t station_idx, std::string& polprod)
{
    make_upper(polprod);
