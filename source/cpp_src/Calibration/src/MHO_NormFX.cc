...
MHO_NormFX::ExecuteOperation()
{
    ...
    //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    //Locate the data of interest for this frequency (fr) and (ap)
    //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    // zero-out the work array containing the spectral data to be transformed
    //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    for (sb = 0; sb < 2; sb++)
    {
        ...
        if (pass->control.vbp_correct){apply_video_bp (xp_spec, nlags/2, pass);}
    ...
    msg ("usbfrac %f lsbfrac %f polcof_sum %f factor %1f flag %x", -2, datum->usbfrac, datum->lsbfrac, polcof_sum, factor, datum->flag);
    /* Collect the results */
