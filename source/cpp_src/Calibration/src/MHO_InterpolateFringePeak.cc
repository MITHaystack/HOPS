...
bool MHO_InterpolateFringePeak::Initialize()
{
...
bool MHO_InterpolateFringePeak::Execute()
{
    fine_peak_interpolation();
    return true;
}

void MHO_InterpolateFringePeak::SetMaxBins(int sbd_max, int mbd_max, int dr_max)
{
    fSBDMaxBin = sbd_max;
    fMBDMaxBin = mbd_max;
    fDRMaxBin = dr_max;
