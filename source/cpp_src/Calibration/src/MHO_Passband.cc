...
bool MHO_Passband::ExecuteInPlace(visibility_type* in)
{
...
bool MHO_Passband::ExecuteOutOfPlace(const visibility_type* in, visibility_type* out)
{
    out->Copy(*in);
    return ExecuteInPlace(out);
}

bool MHO_Passband::InitializeInPlace(visibility_type* /*in*/)
{
    return true;
}

bool MHO_Passband::InitializeOutOfPlace(const visibility_type* /*in*/, visibility_type* /*out*/)
{
    return true;
}
