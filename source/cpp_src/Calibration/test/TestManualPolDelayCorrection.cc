...
int main(int /*argc*/, char** /*argv*/)
{
    ...
    if(test_case1_remote_polY_ref_freq_equals_channel())
        return 1;
    if(test_case2_quarter_turn_and_lsb_sign())
        return 1;
    if(test_case3_ref_station_conjugation())
        return 1;
    if(test_case4_station_mismatch_no_change())
        return 1;
    if(test_case5_recorded_axis_label())
        return 1;
