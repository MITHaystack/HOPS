...
static void oracle_field_rotations(std::complex< double > cpolvalue[4], double par_angle[2], double elevation[2],
...
static int check_all_near(const visibility_type& vis, double expected_re, double expected_im, double tol)
{
...
int main(int /*argc*/, char** /*argv*/)
{
    ...
    if(test_zero_angle_noop())
        return 1;
    if(test_pol_not_in_set_zeroed())
        return 1;
    if(test_sign_pattern())
        return 1;
    if(test_nasmyth_elevation_multiplier())
        return 1;
