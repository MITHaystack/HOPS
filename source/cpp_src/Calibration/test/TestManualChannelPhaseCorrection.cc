...
static int test_case1_remote_polY_both_channels()
{
    ...
    const std::complex< double > exp_neg45(std::cos(MHO_Constants::deg_to_rad * 45.0),
...
int main(int /*argc*/, char** /*argv*/)
{
    ...
    if(test_case1_remote_polY_both_channels())
        return 1;
    if(test_case2_ref_conjugation())
        return 1;
    if(test_case3_label_stripping())
        return 1;
    if(test_case4_exact_suffix_no_match())
        return 1;
    if(test_case5_pol_mismatch())
        return 1;
    if(test_case6_channel_not_in_map())
        return 1;
    if(test_case7_recorded_axis_label())
        return 1;
