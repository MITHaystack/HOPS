...
class MHO_VisibilityChannelizer: public MHO_TransformingOperator< visibility_store_type, ch_visibility_store_type>
{
    public:
    ...
    protected:
        ...
        virtual bool InitializeImpl(const visibility_store_type* in, ch_visibility_store_type* out);
        virtual bool ExecuteImpl(const visibility_store_type* in, ch_visibility_store_type* out);
