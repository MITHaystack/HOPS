                ...
                public MHO_IntervalLabelInterface
{
    ...
    public:
        MHO_Axis(): MHO_VectorContainer< XValueType >(), MHO_IndexLabelInterface(), MHO_IntervalLabelInterface()
        {
        ...
        MHO_Axis(std::size_t dim)
            : MHO_VectorContainer< XValueType >(dim), MHO_IndexLabelInterface(), MHO_IntervalLabelInterface()
        {
            //create and set the pointer to the index label object
            //std::vector<mho_json> tmp;
            this->fObject["index_labels"] = mho_json(); // mho_json::array(); //tmp;
        ...
        MHO_Axis(const MHO_Axis& obj)
            : MHO_VectorContainer< XValueType >(obj), MHO_IndexLabelInterface(), MHO_IntervalLabelInterface()
        {
            if(obj.fObject.contains("index_labels"))
            {
                this->fObject["index_labels"] = obj.fObject["index_labels"];
            }
            if(obj.fObject.contains("interval_labels"))
            {
                this->fObject["interval_labels"] = obj.fObject["interval_labels"];
            }
