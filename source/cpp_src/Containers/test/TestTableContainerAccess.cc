...
int main(int argc, char** argv)
{
    ...
    std::cout
        << "WARNING: Also make sure to run this without other background processes using large amounts of system resources."
        << std::endl;
    ...
    std::cout << "largest percent difference in access time between each access method is: " << dmax * 100.0 << "\%"
              << std::endl;
