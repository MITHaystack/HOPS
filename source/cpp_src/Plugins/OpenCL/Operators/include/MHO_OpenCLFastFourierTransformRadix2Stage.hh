    ...
    public MHO_MultidimensionalFastFourierTransformInterface< XArgType >
{
    ...
    protected:
        ...
        virtual bool InitializeInPlace(XArgType* in) override
        {
            ...
            if(fIsValid)
            {
                ...
                if(fDimensionSize[ fActiveAxisIndex ] != in->GetDimension( fActiveAxisIndex )){need_to_resize = true;}
                if(need_to_resize)
                {
    ...
    private:
        ...
        void BuildKernel()
        {
            ...
            fKernel = k_builder.BuildKernel(clFile.str(), std::string("MultidimensionalFastFourierTransform_Radix2Stage"), options.str());
