...
//FFT_NDIM
#define FFT_BUFFERSIZE 4096  //TODO set this based on input data dimensions, how do we detect the max allowable?

__kernel void
MultidimensionalFastFourierTransform_PrivateRadix2Stage(
...
)
{
    ...
    __global CL_TYPE2* chunk;//start of the data location we read in 
    __private CL_TYPE2 buffer[FFT_BUFFERSIZE]; //private workspace
