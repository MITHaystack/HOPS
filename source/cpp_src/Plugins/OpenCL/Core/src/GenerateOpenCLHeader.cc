...
int main()
{
    ...
    std::cout<<"         at build time.  Any changes to this file will be erased when HOPS"<<std::endl;
    ...
    if (double_precision){sourceCode = KernelSource;}
    else{sourceCode = KernelSource_f;}
