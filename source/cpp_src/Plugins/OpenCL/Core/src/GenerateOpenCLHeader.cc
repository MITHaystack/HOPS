...
int main()
{
    ...
    std::cout << "/* Generated using platform #" << HOPS_OPENCL_PLATFORM << " out of " << platforms.size() << " platforms. */"
              << std::endl;
    std::cout << std::endl;

    // Select the default platform and create a context using this platform and the GPU
    cl_context_properties cps[3] = {CL_CONTEXT_PLATFORM, (cl_context_properties)(platforms[HOPS_OPENCL_PLATFORM])(), 0};
