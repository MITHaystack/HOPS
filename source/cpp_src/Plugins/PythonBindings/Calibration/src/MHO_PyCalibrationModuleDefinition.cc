...
PYBIND11_MODULE(pyMHO_Calibration, m)
{
    ...
    py::class_< MHO_NotchComb, MHO_Operator >(m, "MHO_NotchComb")
        .def(py::init<>())
        .def("set_notch_offset", &MHO_NotchComb::SetNotchOffset, "set notch frequency starting offset from DC in MHz")
        .def("get_notch_offset", &MHO_NotchComb::GetNotchOffset)
        .def("set_notch_period", &MHO_NotchComb::SetNotchPeriod, "set notch periodic spacing in MHz")
        .def("get_notch_period", &MHO_NotchComb::GetNotchPeriod)
        .def("set_notch_width", &MHO_NotchComb::SetNotchWidth, "set notch width in MHz")
