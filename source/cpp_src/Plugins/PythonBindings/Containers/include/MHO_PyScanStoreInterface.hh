...
class MHO_PyScanStoreInterface
{
    public:
        ...
        MHO_PyScanStoreInterface(MHO_ScanDataStore* scan_store): fScanStore(scan_store)
        {
            fIsOwned = false;
            fInitialized = false;
...
void DeclarePyScanStoreInterface(py::module& m, std::string pyclass_name)
{
    py::class_< MHO_PyScanStoreInterface >(m, pyclass_name.c_str())
        ...
        .def("set_directory", &hops::MHO_PyScanStoreInterface::SetDirectory,
             "specify the path to the directory of the scan to be loaded", py::arg("directory"))
        .def("initialize", &hops::MHO_PyScanStoreInterface::Initialize,
             "initialize the scan storage container after setting the directory")
        .def("is_valid", &hops::MHO_PyScanStoreInterface::IsValid, "check if initialization was successful")
        .def("has_baseline", &hops::MHO_PyScanStoreInterface::IsBaselinePresent,
             "check if baseline (2-char code) is present in this scan", py::arg("baseline"))
        .def("has_station", &hops::MHO_PyScanStoreInterface::IsStationPresent,
             "check if station (1-char code) is present in this scan", py::arg("station"))
        .def("has_fringe", &hops::MHO_PyScanStoreInterface::IsFringePresent,
             "check if fringe file (file basename) is present in this scan", py::arg("fringe_file_basename"))
        ...
        .def("get_nstations", &hops::MHO_PyScanStoreInterface::GetNStations, "get the number of stations in the current scan")
        .def("get_nfringes", &hops::MHO_PyScanStoreInterface::GetNFringes, "get the number of fringe files in the current scan")
        ...
        .def("get_baseline_filename", &hops::MHO_PyScanStoreInterface::GetBaselineFilename,
             "get the filename associated with the baseline 2-char code", py::arg("baseline"))
        .def("get_station_filename", &hops::MHO_PyScanStoreInterface::GetStationFilename,
             "get the filename associated with the station 1-char code", py::arg("station"))
        .def("get_fringe_filename", &hops::MHO_PyScanStoreInterface::GetFringeFilename,
             "get the filename associated with the fringe basename", py::arg("fringe"))
        .def("load_baseline", &hops::MHO_PyScanStoreInterface::LoadBaseline, "load the baseline data container into memory",
             py::arg("baseline"))
        .def("load_station", &hops::MHO_PyScanStoreInterface::LoadStation, "load the station data container into memory",
             py::arg("station"))
        .def("load_fringe", &hops::MHO_PyScanStoreInterface::LoadFringe, "load the fringe data container into memory",
             py::arg("fringe"))
        ...
        .def(
            "get_baseline_data", //lambda for returing either baseline data or None-type
            ...
            py::return_value_policy::reference, "get the baseline data container that has been loaded into memory",
            py::arg("baseline"))
        .def(
            "get_station_data", //lambda for returing either station data or None-type
            ...
            py::return_value_policy::reference, "get the station data container that has been loaded into memory",
            py::arg("station"))
        .def(
            "get_fringe_data", //lambda for returing either fringe data or None-type
            ...
            py::return_value_policy::reference, "get the fringe data container that has been loaded into memory",
            py::arg("fringe"))
