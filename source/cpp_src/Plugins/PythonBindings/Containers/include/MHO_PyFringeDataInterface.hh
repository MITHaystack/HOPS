...
inline void DeclarePyFringeDataInterface(py::module& m, std::string pyclass_name)
{
    py::class_< MHO_PyFringeDataInterface >(m, pyclass_name.c_str())
        ...
        .def("get_parameter_store", &hops::MHO_PyFringeDataInterface::GetParameterStore, py::return_value_policy::reference,
             "get the current parameter set object")
        .def("get_container_store", &hops::MHO_PyFringeDataInterface::GetContainerStore, py::return_value_policy::reference,
             "get the current container store object")
        .def("get_scan_store", &hops::MHO_PyFringeDataInterface::GetScanStore, py::return_value_policy::reference,
             "get the current scan data store object")
        .def("get_vex", &hops::MHO_PyFringeDataInterface::GetVex, py::return_value_policy::copy,
             "get the current scan ovex/root data as a python dictionary")
        .def("get_plot_data", &hops::MHO_PyFringeDataInterface::GetPlotData, py::return_value_policy::copy,
