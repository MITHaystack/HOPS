...
inline void DeclarePyParameterStoreInterface(py::module& m, std::string pyclass_name)
{
    py::class_< MHO_PyParameterStoreInterface >(m, pyclass_name.c_str())
        ...
        .def("is_present", &hops::MHO_PyParameterStoreInterface::IsPresent,
             "check if parameter with specified path is present in the store", py::arg("value_path"))
        .def("get_by_path", &hops::MHO_PyParameterStoreInterface::Get, "get parameter at path", py::arg("value_path"))
        .def("set_by_path", &hops::MHO_PyParameterStoreInterface::Set, "set the value of the parameter at the specified path",
             py::arg("value_path"), py::arg("value"))
