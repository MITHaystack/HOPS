...
hid_t inline create_complex_dtype_float()
{
...
hid_t inline create_complex_dtype_double()
{
...
template<> inline hid_t MHO_HDF5TypeCode< int8_t >()
{
    return H5T_NATIVE_CHAR;
}

template<> inline hid_t MHO_HDF5TypeCode< uint8_t >()
{
    return H5T_NATIVE_UCHAR;
}

template<> inline hid_t MHO_HDF5TypeCode< int16_t >()
{
    return H5T_NATIVE_SHORT;
}

template<> inline hid_t MHO_HDF5TypeCode< uint16_t >()
{
    return H5T_NATIVE_USHORT;
}

template<> inline hid_t MHO_HDF5TypeCode< int32_t >()
{
    return H5T_NATIVE_INT;
}

template<> inline hid_t MHO_HDF5TypeCode< uint32_t >()
{
    return H5T_NATIVE_UINT;
}

template<> inline hid_t MHO_HDF5TypeCode< int64_t >()
{
    return H5T_NATIVE_LLONG;
}

template<> inline hid_t MHO_HDF5TypeCode< uint64_t >()
{
    return H5T_NATIVE_ULLONG;
}

template<> inline hid_t MHO_HDF5TypeCode< float >()
{
    return H5T_NATIVE_FLOAT;
}

template<> inline hid_t MHO_HDF5TypeCode< double >()
{
