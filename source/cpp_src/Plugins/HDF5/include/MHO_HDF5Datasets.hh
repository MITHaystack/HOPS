...
template<>
inline void make_scalar_dataset< std::string >(hid_t group_id, hid_t& dataset_id, const std::string& name, const std::string& value) 
{
...
template<>
herr_t 
inline make_scale< std::string>(hid_t group_id, hid_t dataset_id, std::size_t axis_idx,
                         const std::string& parent_name,
                         const std::string& name,
...
//1-D string dataset 
herr_t 
inline make_string_vector_dataset(hid_t group_id, hid_t dataset_id,
                                  const std::string& name,
                                  const std::vector< std::string >* data, 
                                  const mho_json& metadata) 
{
...
//                 {
//                     std::vector<int> dvec = value.get< std::vector<int> >();
//                     hid_t dset_id;
//                     hsize_t dims[1]; dims[0] = dvec.size();
//                     mho_json dummy;
//                     make_dataset(parent_group, dset_id, key, 1, dims, dvec.data(), dummy);
//                 }
//                 if(value.begin()->is_number_unsigned())
//                 {
//                     std::vector<unsigned int> dvec = value.get< std::vector<unsigned int> >();
//                     hid_t dset_id;
//                     hsize_t dims[1]; dims[0] = dvec.size();
//                     mho_json dummy;
//                     make_dataset(parent_group, dset_id, key, 1, dims, dvec.data(), dummy);
...
//                 {
//                     std::vector<std::string> dvec = value.get< std::vector< std::string > >();
//                     hid_t dset_id;
//                     hsize_t dims[1]; dims[0] = dvec.size();
//                     mho_json dummy;
//                     make_string_vector_dataset(parent_group, dset_id, key, &dvec, dummy );
//                 }
//             }
//             else 
//             {
...
//         {
//             hid_t dset_id;
//             make_scalar_dataset(parent_group, dset_id, key, value);
