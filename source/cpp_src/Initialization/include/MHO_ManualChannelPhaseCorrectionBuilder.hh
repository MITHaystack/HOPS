#ifndef MHO_ManualChannelPhaseCorrectionBuilder_HH__
#define MHO_ManualChannelPhaseCorrectionBuilder_HH__
...
#endif /*! end of include guard: MHO_ManualChannelPhaseCorrectionBuilder_HH__ */
