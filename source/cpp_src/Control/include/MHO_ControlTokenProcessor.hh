...
class MHO_ControlTokenProcessor
{
    public:
        ...
        /**
         * @brief Processes a real (number) token and converts it to an mho_json value.
         *
        ...
        /**
         * @brief Processes a list of (string) tokens and converts them into an mho_json object.
         *
