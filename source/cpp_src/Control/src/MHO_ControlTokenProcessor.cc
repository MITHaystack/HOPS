...
mho_json MHO_ControlTokenProcessor::ProcessInt(const MHO_Token& token)
{
...
mho_json MHO_ControlTokenProcessor::ProcessString(const MHO_Token& token)
{
    mho_json element_data = token.fValue;
    return element_data;
}

mho_json MHO_ControlTokenProcessor::ProcessReal(const MHO_Token& token)
{
    mho_json element_data;
    double value;
...
mho_json MHO_ControlTokenProcessor::ProcessListInt(const std::vector< MHO_Token >& tokens)
{
    mho_json element_data;
...
mho_json MHO_ControlTokenProcessor::ProcessListString(const std::vector< MHO_Token >& tokens)
{
    mho_json element_data;
...
mho_json MHO_ControlTokenProcessor::ProcessFixedLengthListString(const std::vector< MHO_Token >& tokens)
{
    mho_json element_data;
    std::vector< std::string > values;
...
mho_json MHO_ControlTokenProcessor::ProcessListReal(const std::vector< MHO_Token >& tokens)
{
    mho_json element_data;
...
mho_json MHO_ControlTokenProcessor::ProcessBool(const MHO_Token& token)
{
    mho_json element_data;
    bool value;
...
bool MHO_ControlTokenProcessor::ConvertFloat(const MHO_Token& token, double& val)
{
    char* pend;
...
bool MHO_ControlTokenProcessor::ConvertInteger(const MHO_Token& token, int& val)
{
    char* pend;
...
bool MHO_ControlTokenProcessor::ConvertBool(const MHO_Token& token, bool& val)
{
    bool ok = false;
    if(token.fValue == "false")
    {
        val = false;
        ok = true;
    }
    if(token.fValue == "true")
    {
        val = true;
        ok = true;
    }
