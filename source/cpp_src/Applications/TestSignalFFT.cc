...
int main(int argc, char** argv)
{
    ...
    data_type noise_samples;
    noise_samples.Resize(n_samples);
    data_type tone_samples;
    tone_samples.Resize(n_samples);
    data_type sum_samples;
    sum_samples.Resize(n_samples);
    ...
    data_type ft_noise_samples;
    ft_noise_samples.Copy(noise_samples); //ft_noise_samples.Resize(n_samples);
    data_type ft_tone_samples;
    ft_tone_samples.Copy(tone_samples); //ft_tone_samples.Resize(n_samples);
    data_type ft_sum_samples;
    ft_sum_samples.Copy(sum_samples); //ft_sum_samples.Resize(n_samples);
