...
int main(int argc, char** argv)
{
    ...
    msg_debug("main", "pcal object 'A' has size: (" << pcal1->GetDimension(0) << ", " << pcal1->GetDimension(1) << ", "
                                                    << pcal1->GetDimension(2) << ") " << eom);

    msg_debug("main", "pcal object 'B' has size: (" << pcal2->GetDimension(0) << ", " << pcal2->GetDimension(1) << ", "
    ...
    if(rel_L1_norm > 10 * SINGLE_PRECISION_MACHINE_EPS)
    {
        return 1;
    }
