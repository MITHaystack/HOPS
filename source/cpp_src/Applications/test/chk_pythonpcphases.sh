...
# this test exercises an embedded-Python plug-in operator (set python_finalize ...);
# skip it when HOPS was built without the embedded interpreter
# (HOPS_ENABLE_EMBEDDED_PYTHON=OFF).
