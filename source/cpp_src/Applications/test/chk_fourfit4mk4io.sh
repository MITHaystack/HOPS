...
echo "Running: fourfit4 -m 4 -K -c ./test0.cf -b AS -P RR ./${MK4_SCAN_DIR}"
output_file=$(fourfit4 -m 4 -K -c ./test0.cf -b AS -P RR ./${MK4_SCAN_DIR} 2>&1 | awk '{print $NF}')
...
echo "Running: fourfit4 -m 4 -Kk -c ./test0.cf -b AS -P RR ./${MK4_SCAN_DIR}"
mk4_output_file=$(fourfit4 -m 4 -Kk -c ./test0.cf -b AS -P RR ./${MK4_SCAN_DIR} 2>&1 | awk '{print $NF}')
echo "fourfit4 mark4 output file: $mk4_output_file"

#make sure the mark4 file was generated
MK4_OUT_OK=0
if [ -f "${mk4_output_file}" ]; then
echo "fourfit4 mark4 output generated ok"
  MK4_OUT_OK=1
fi
