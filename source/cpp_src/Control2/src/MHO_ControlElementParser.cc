...
void 
MHO_ControlElementParser::LoadBlockFormat(std::string block_name)
{
...
std::string 
MHO_ControlElementParser::GetBlockFormatFileName(std::string block_name)
{
...
mho_json
MHO_ControlElementParser::ParseBlockLines(std::string block_name, const std::vector< MHO_VexLine >* block_lines)
{
...
mho_json
MHO_ControlElementParser::ParseBlock()
{
    mho_json block_root;
...
mho_json 
MHO_ControlElementParser::ParseGlobalBlock()
{
    mho_json block_root;
...
bool
MHO_ControlElementParser::IsStartTag(const MHO_VexLine& line)
{
...
bool 
MHO_ControlElementParser::IsStopTag(const MHO_VexLine& line)
{
...
bool 
MHO_ControlElementParser::IsReferenceTag(const MHO_VexLine& line)
{
...
bool 
MHO_ControlElementParser::ProcessReference(const MHO_VexLine& line, 
                                     std::stack< std::string >& path,
                                     mho_json* file_node,
