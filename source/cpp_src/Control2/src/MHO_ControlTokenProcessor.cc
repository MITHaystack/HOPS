...
mho_json 
MHO_ControlTokenProcessor::ProcessInt(const std::string& element_name,
                                  mho_json& format, 
...
mho_json 
MHO_ControlTokenProcessor::ProcessListInt(const std::string& element_name, 
                                      mho_json& format, 
                                      std::vector< std::string >& tokens)
{
...
mho_json 
MHO_ControlTokenProcessor::ProcessListString(const std::string& element_name, 
                                         mho_json& format, 
                                         std::vector< std::string >& tokens)
{
    mho_json element_data;
...
mho_json 
MHO_ControlTokenProcessor::ProcessReal(const std::string& element_name,
                                   mho_json& format,
                                   std::vector< std::string >& tokens)
{
    mho_json element_data;
...
mho_json 
MHO_ControlTokenProcessor::ProcessListReal(const std::string& element_name,
                                       mho_json& format, 
                                       std::vector< std::string >& tokens)
{
    mho_json element_data;
...
bool 
MHO_ControlTokenProcessor::ContainsWhitespace(std::string value)
{
